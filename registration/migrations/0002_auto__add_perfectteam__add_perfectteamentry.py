...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PerfectTeam'
        db.create_table('registration_perfectteam', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('player_1', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('player_2', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('player_3', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('player_4', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('registration', ['PerfectTeam'])

        # Adding model 'PerfectTeamEntry'
        db.create_table('registration_perfectteamentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.PerfectTeam'])),
            ('from_member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['foundry.Member'])),
            ('friend_1_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('friend_1_mobile_number', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('friend_1_invite', self.gf('django.db.models.fields.related.ForeignKey')(related_name='perfect_team_friend_1', to=orm['registration.OffSiteInvite'])),
            ('friend_2_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('friend_2_mobile_number', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('friend_2_invite', self.gf('django.db.models.fields.related.ForeignKey')(related_name='perfect_team_friend_2', to=orm['registration.OffSiteInvite'])),
            ('friend_3_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('friend_3_mobile_number', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('friend_3_invite', self.gf('django.db.models.fields.related.ForeignKey')(related_name='perfect_team_friend_3', to=orm['registration.OffSiteInvite'])),
            ('friend_4_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('friend_4_mobile_number', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('friend_4_invite', self.gf('django.db.models.fields.related.ForeignKey')(related_name='perfect_team_friend_4', to=orm['registration.OffSiteInvite'])),
        ))
        db.send_create_signal('registration', ['PerfectTeamEntry'])


    def backwards(self, orm):
        
        # Deleting model 'PerfectTeam'
        db.delete_table('registration_perfectteam')

        # Deleting model 'PerfectTeamEntry'
        db.delete_table('registration_perfectteamentry')
    ...
    models = {
        ...
        'registration.perfectteamentry': {
            ...
            'friend_1_mobile_number': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'friend_1_name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            ...
            'friend_2_mobile_number': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'friend_2_name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            ...
            'friend_3_mobile_number': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'friend_3_name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            ...
            'friend_4_mobile_number': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'friend_4_name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),

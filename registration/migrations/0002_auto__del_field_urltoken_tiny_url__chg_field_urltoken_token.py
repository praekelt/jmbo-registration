...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'URLToken.tiny_url'
        db.delete_column('registration_urltoken', 'tiny_url')


        # Changing field 'URLToken.token'
        db.alter_column('registration_urltoken', 'token', self.gf('django.db.models.fields.CharField')(max_length=8))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'URLToken.tiny_url'
        raise RuntimeError("Cannot reverse this migration. 'URLToken.tiny_url' and its values cannot be restored.")

        # Changing field 'URLToken.token'
        db.alter_column('registration_urltoken', 'token', self.gf('django.db.models.fields.CharField')(max_length=40))
    models = {
        'auth.group': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PerfectTeamEntry.friend_1_invite'
        db.alter_column('registration_perfectteamentry', 'friend_1_invite_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['registration.OffSiteInvite']))

        # Changing field 'PerfectTeamEntry.friend_2_invite'
        db.alter_column('registration_perfectteamentry', 'friend_2_invite_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['registration.OffSiteInvite']))

        # Changing field 'PerfectTeamEntry.friend_4_invite'
        db.alter_column('registration_perfectteamentry', 'friend_4_invite_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['registration.OffSiteInvite']))

        # Changing field 'PerfectTeamEntry.friend_3_invite'
        db.alter_column('registration_perfectteamentry', 'friend_3_invite_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['registration.OffSiteInvite']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PerfectTeamEntry.friend_1_invite'
        raise RuntimeError("Cannot reverse this migration. 'PerfectTeamEntry.friend_1_invite' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PerfectTeamEntry.friend_2_invite'
        raise RuntimeError("Cannot reverse this migration. 'PerfectTeamEntry.friend_2_invite' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PerfectTeamEntry.friend_4_invite'
        raise RuntimeError("Cannot reverse this migration. 'PerfectTeamEntry.friend_4_invite' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PerfectTeamEntry.friend_3_invite'
        raise RuntimeError("Cannot reverse this migration. 'PerfectTeamEntry.friend_3_invite' and its values cannot be restored.")
